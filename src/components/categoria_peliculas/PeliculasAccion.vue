<template>
  ...
  <div class="cont_info_carousel">
    <div class="cont_title">
      <h3 class="title">Películas de acción</h3>
      <div class="cont_icon">
  ...
  <div class="container_carousel">
    <div class="cont_pagination">
      <div class="pagination_elPAC"></div>
    </div>
    <swiper
      :slides-per-view="9"
      :slides-per-group="5"
    ...
    <div class="cont_buttons">
      <div class="button-pPAC">
        <font-awesome-icon
          class="icon_right"
          icon="fa-solid fa-chevron-left"
        />
      </div>
      <div class="button-nPAC">
        <font-awesome-icon
          class="icon_left"
...
setup() {
  ...
  onMounted(() => {
    setTimeout( async() => {
      await services.movie_action(getPageRandom(pageNumMax.value, numMin))
      .then((response) => {
...
.container_carousel:hover .pagination_elPAC,
