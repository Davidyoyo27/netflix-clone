<template>
    ...
    <div class="container_carousel">
      ...
      <div class="cont_buttons">
        <div class="button-pPA">
          <font-awesome-icon
            class="icon_right"
            icon="fa-solid fa-chevron-left"
          />
        </div>
        <div class="button-nPA">
          <font-awesome-icon
            class="icon_left"
...
import { numMaxPA, numMin } from "@/helpers/js/variables.js";
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      await services.movie_anime(getPageRandom(numMaxPA, numMin))
        .then((response) => {
...
.container_carousel:hover .pagination_elPA,
