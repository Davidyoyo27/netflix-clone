  ...
  <div v-if="flagRenderShadow" class="container">
    <div class="cont_info_carousel">
      <div class="cont_title">
        <h3 class="title">Películas de Hollywood para reír</h3>
        <div class="cont_icon">
    ...
    <div class="container_carousel">
      ...
      <div class="cont_buttons">
        <div class="button-pPC">
          <font-awesome-icon
            class="icon_right"
            icon="fa-solid fa-chevron-left"
          />
        </div>
        <div class="button-nPC">
          <font-awesome-icon
            class="icon_left"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      setTimeout( async() => {
        await services.movie_comedy(getPageRandom(pageNumMax.value, numMin))
        .then((response) => {
...
.container_carousel:hover .pagination_elPC,
