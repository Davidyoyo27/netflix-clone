<template>
  ...
  <div class="cont_info_carousel">
    <div class="cont_title">
      <h3 class="title">Películas documentales</h3>
      <div class="cont_icon">
  ...
  <div class="container_carousel">
    ...
    <div class="cont_buttons">
      <div class="button-pPD">
        <font-awesome-icon
          class="icon_right"
          icon="fa-solid fa-chevron-left"
        />
      </div>
      <div class="button-nPD">
        <font-awesome-icon
          class="icon_left"
...
setup() {
  ...
  onMounted(() => {
    setTimeout( async() => {
      await services.movie_documental(getPageRandom(pageNumMax.value, numMin))
      .then((response) => {
...
.container_carousel:hover .pagination_elPD,
