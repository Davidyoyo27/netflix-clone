<template>
  ...
  <div class="cont_info_carousel">
    <div class="cont_title">
      <h3 class="title">Películas documentales de EEUU</h3>
      <div class="cont_icon">
  ...
  <div class="container_carousel">
    <div class="cont_pagination">
      <div class="pagination_elPDEU"></div>
    </div>
    <swiper
      :slides-per-view="9"
      :slides-per-group="5"
    ...
    <div class="cont_buttons">
      <div class="button-pPDEU">
        <font-awesome-icon
          class="icon_right"
          icon="fa-solid fa-chevron-left"
        />
      </div>
      <div class="button-nPDEU">
        <font-awesome-icon
          class="icon_left"
...
setup() {
  ...
  onBeforeMount(() => {
    ...
    services.movie_documental_EEUU(1)
      .then((response) => {
  ...
  onMounted(() => {
    setTimeout( async() => {
      await services.movie_documental_EEUU(getPageRandom(pageNumMax.value, numMin))
      .then((response) => {
...
.container_carousel:hover .pagination_elPDEU,
