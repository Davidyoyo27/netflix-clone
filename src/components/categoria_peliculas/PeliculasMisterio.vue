<template>
  ...
  <div class="cont_info_carousel">
    <div class="cont_title">
      <h3 class="title">Películas de misterio</h3>
      <div class="cont_icon">
...
setup() {
  ...
  onMounted(() => {
    setTimeout( async() => {
      await services.movie_mistery(getPageRandom(pageNumMax.value, numMin))
      .then((response) => {
...
.container_carousel:hover .pagination_elPM,
