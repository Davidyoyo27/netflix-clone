<template>
  <div class="cont_info_carousel">
    <h3 class="title">Las 10 series más populares en Chile hoy</h3>
  </div>
  <div class="container_carousel">
    <div class="cont_pagination">
      <div class="pagination_elT10S"></div>
    </div>
    <swiper
      :slides-per-view="6"
      :slides-per-group="4"
...
.container_carousel:hover .pagination_elT10S,
