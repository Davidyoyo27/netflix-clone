      ...
      <div class="box_left">
        ...
        <div v-if="flagVisibleSubmenu" id="submenu">
          ...
          <div class="submenu_items">
            <span @click="sendFilter(sugerencias)">Sugerencias para ti</span>
            <span @click="sendFilter(lanzamiento)">Año de lanzamiento</span>
            <span @click="sendFilter(ordenAZ)">A-Z</span>
            <span @click="sendFilter(ordenZA)">Z-A</span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  setup() {
    ...
    const lanzamiento = ref("primary_release_date.desc");
    // filtro orden alfabetico A-Z
    const ordenAZ = ref("original_title.asc");
    // filtro orden alfabetico Z-A
    const ordenZA = ref("original_title.desc");
    ...
    const sendFilter = (filter) => {
      ...
      store.dispatch("actualizarFiltroSugerencias", filter);
