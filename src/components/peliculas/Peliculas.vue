...
export default {
  ...
  setup() {
    ...
    const endpoint = ref("without_genres=37&with_original_language=en&release_date.gte=2015");
    const pageMax = ref(88);
    ...
    onMounted(async () => {
      ...
      `/discover/movie?language=es-MX&${endpoint.value}&with_watch_providers=8&watch_region=CL`);
