...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("TV asiática");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(13, 1),
      "/discover/tv?sort_by=popularity.desc&with_watch_providers=8&watch_region=CL&language=es-MX&with_origin_country=JP|KR&without_genres=16");
