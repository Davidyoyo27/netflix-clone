...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series británicas");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&without_genres=16&with_original_language=en&with_watch_providers=8&watch_region=CL");
