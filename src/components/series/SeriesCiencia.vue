...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("TV sobre ciencia y naturaleza");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=99&with_keywords=221355|284176&with_watch_providers=8&watch_region=CL");
