...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series de comedia");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=35&without_genres=16&with_original_language=en&with_watch_providers=8&watch_region=CL");
