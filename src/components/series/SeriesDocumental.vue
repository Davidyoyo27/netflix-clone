...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series documentales");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(18, 1),
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=99&with_watch_providers=8&watch_region=CL");
