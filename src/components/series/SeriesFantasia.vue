...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series de sci-fi y fantasía");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(11, 1),
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=10765&without_genres=10762&without_keywords=210024&with_watch_providers=8&watch_region=CL");
