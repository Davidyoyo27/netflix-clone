...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Contenido infantil");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(10, 1),
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=10762&page=1&with_watch_providers=8&watch_region=CL");
