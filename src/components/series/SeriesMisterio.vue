...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series de misterio");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=9648&with_watch_providers=8&watch_region=CL");
