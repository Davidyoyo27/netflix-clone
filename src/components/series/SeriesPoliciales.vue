...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series policiales");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(2, 1),
      "/discover/tv?language=es-MX&first_air_date.gte=2010&without_genres=16&with_keywords=6149&with_watch_providers=8&watch_region=CL");
