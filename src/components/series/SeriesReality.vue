...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Reality shows, variedades y entrevistas");
    ...
    onMounted(async () => {
      ...
      const response = await services.get_movie_services(getPageRandom(12, 1),
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_genres=10764&without_genres=16&with_watch_providers=8&watch_region=CL");
