...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series románticas");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&without_genres=16&with_keywords=9840&with_watch_providers=8&watch_region=CL");
