...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Especiales de stand up");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2010&with_keywords=9716&with_watch_providers=8&watch_region=CL");
