...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Series de terror");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2005&with_keywords=315058&without_keywords=210024&with_watch_providers=8&watch_region=CL");
