...
export default {
  ...
  setup() {
    ...
    const nameTitleSection = ref("Thrillers de TV");
    ...
    onMounted(async () => {
      ...
      "/discover/tv?language=es-MX&first_air_date.gte=2005&with_keywords=316362&with_watch_providers=8&watch_region=CL");
