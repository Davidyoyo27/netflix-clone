...
const routes = [
    ...
    // prueba componente buscar pelicula menu inicio
    { path: '/prueba_menu_gradient', component: () => import(/* webpackChunkName: "PruebaMenuGradient.vue" */ '../components/PruebaMenuGradient') },
    // page 404 Not Found
